...
<body class="text-black font-poppins pt-10 pb-[50px]">
    ...
    <section id="Top-Categories" class="max-w-[1200px] mx-auto flex flex-col p-[70px_50px] gap-[30px]">
        ...
        <div class="grid grid-cols-4 gap-[30px]">
            ...
            <a href="{{ route('front.category', 'business-intelligance' ) }}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    ...
                    <div class="flex flex-col rounded-t-[12px] rounded-b-[24px] gap-[32px] bg-white w-full pb-[10px] overflow-hidden transition-all duration-300 hover:ring-2 hover:ring-[#FF6129]">
                        ...
                        <div class="flex flex-col px-4 gap-[10px]">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div class="flex flex-col">
                                    {{-- masuk ke course, masuk ke teacher, masuk ke user, lalu ambil namenya (course, teacher, user saling berelasi) --}}
